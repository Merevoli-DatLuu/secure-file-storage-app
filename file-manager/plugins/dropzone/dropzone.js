let Emitter = require(__dirname + "\\emitter.js");



module.exports = class Dropzone extends Emitter {
  static initClass() {
...
let defaultOptions = require(__dirname + "\\options.js");
let Dropzone  = require(__dirname + "\\dropzone.js");
